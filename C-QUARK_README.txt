...
1. What is C-QUARK Suite?
   ...
   The C-QUARK Suite is a composite package of programs for protein
   structure prediction. The Suite includes the following programs:
...
2. How to install the C-QUARK Suite?
   ...
   a) download the C-QUARK Suite 'C-QUARK-1.0.tar.bz2' from
      http://zhanglab.ccmb.med.umich.edu/C-QUARK/download
   ...
   b) Download C-QUARK library files from
      https://zhanglab.ccmb.med.umich.edu/C-QUARK/download 
...
4.2. How to run C-QUARK?
   ...
   e) we put the example in example folder and the expected results to example_out folder, 
      the example will take around 50-60 hours run on a singe core cumputer.
